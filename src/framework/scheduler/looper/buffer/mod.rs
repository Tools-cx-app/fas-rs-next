...
impl Buffer {
    ...
    fn try_calculate(&mut self, #[cfg(feature = "extension")] extension: &Extension) {
    ...
    pub fn additional_frametime(&mut self, #[cfg(feature = "extension")] extension: &Extension) {
